                    ...
                    <section className="page-intro">
                        <div className="page-intro-wrapper">
                            <div className='status-panel'>
                                <StatusItem title={"Duration"} content={["24 hours (over 2 weeks)"]} />
                                <StatusItem title={"Team Size"} content={["Personal"]} />
                                <StatusItem title={"Tools"} content={["Adobe [XD, Photoshop, Illustrator]"]} />
                            </div>
                            <div className="files">
                                <div>
                                    <a href="https://www.artstation.com/artwork/L3QbNR" target="_blank" rel="noopener noreferrer">View on ArtStation</a>
                                </div>
                                <div>
                                    <a href="http://www.google.se" target="_blank" rel="noopener noreferrer">asd</a>
                                </div>
                            </div>
