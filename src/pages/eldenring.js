        ...
        <div className="page-content" id="content">
              ...
              <div className="definitions">
                <div>
                  ...
                  <p>
                    ...
                    and imitate the <b>FROM SOFTWARE</b> style.
                  </p>
                  <br />
                  <p>
          ...
          <section className="page-media">
            <div className="page-media-wrapper">
              <h2>Theme</h2>
              <p>
                With the identical goal as my other project,{' '}
                <Link to={'/battlefield6'}>Battlefield 6</Link>, I wanted to
